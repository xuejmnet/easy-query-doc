import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o,c,a as n,d as t,b as s,e as l}from"./app-71423ce0.js";const i="/easy-query-doc/easy-qeury-solon-web-install.png",u="/easy-query-doc/easy-query-solon-web-query-topic.png",r={},d=n("h2",{id:"国产框架solon配置",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#国产框架solon配置","aria-hidden":"true"},"#"),s(" 国产框架Solon配置")],-1),k=n("p",null,[n("code",null,"easy-query"),s("在"),n("code",null,"^1.2.6"),s("正式支持"),n("code",null,"Solon"),s("适配国产框架的orm部分。")],-1),m=n("h2",{id:"什么是solon",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#什么是solon","aria-hidden":"true"},"#"),s(" 什么是Solon")],-1),v={href:"https://solon.noear.org/",target:"_blank",rel:"noopener noreferrer"},b=n("code",null,"Solon",-1),g=n("strong",null,"Java 新的生态型应用开发框架：更快、更小、更简单。",-1),y=n("p",null,"启动快 5 ～ 10 倍；qps 高 2～ 3 倍；运行时内存节省 1/3 ~ 1/2；打包可以缩到 1/2 ~ 1/10；同时支持 jdk8, jdk11, jdk17, jdk20, graalvm native image。",-1),h=n("h2",{id:"获取最新",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#获取最新","aria-hidden":"true"},"#"),s(" 获取最新")],-1),f={href:"https://central.sonatype.com/",target:"_blank",rel:"noopener noreferrer"},q=n("code",null,"com.easy-query",-1),w=l('<h2 id="快速开始" tabindex="-1"><a class="header-anchor" href="#快速开始" aria-hidden="true">#</a> 快速开始</h2><h2 id="新建java-maven项目" tabindex="-1"><a class="header-anchor" href="#新建java-maven项目" aria-hidden="true">#</a> 新建java maven项目</h2><img src="'+i+`"><h3 id="添加项目依赖" tabindex="-1"><a class="header-anchor" href="#添加项目依赖" aria-hidden="true">#</a> 添加项目依赖</h3><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">&gt;</span></span>
...
<span class="token key atrule">easy-query</span><span class="token punctuation">:</span> 
  ...
  <span class="token key atrule">db1</span><span class="token punctuation">:</span>
    <span class="token comment"># 支持mysql pgsql h2 mssql dameng等其余数据库在适配中</span>
