import{_ as p,W as c,X as l,Y as s,Z as n,$ as t,a0 as e,C as i}from"./framework-7a1bedf3.js";const o={},u=e('<h1 id="easy-query「性能」对比" tabindex="-1"><a class="header-anchor" href="#easy-query「性能」对比" aria-hidden="true">#</a> easy-query「性能」对比</h1><p>当前性能比较代码来自<code>Mybatis-Flex</code>,原本是<code>Mybatis-Flex</code>和<code>Mybaits-Plus</code>的「性能」对比，再他们的基础上删除了json的typehandler,增加了自己的测试代码， 并且增加了获取1w条记录的性能测试。</p><p>直接放结论:目前各项指标<code>easy-query</code>和<code>Mybatis-Flex</code>相近甚至更快,再获取1W条记录的情况下更是遥遥领先与另外两个框架。</p><p>本文只阐述了「性能」方面的对比。</p><h2 id="测试方法" tabindex="-1"><a class="header-anchor" href="#测试方法" aria-hidden="true">#</a> 测试方法</h2><p>使用 h2 数据库，在初始化的时候分别为easy-query和 mybatis-flex 和 mybatis-plus 创建三个不同的数据库， 但是完全一样的数据结构、数据内容和数据量（每个库 2w 条数据）。</p><p>开始之前先进行预热，之后通过打印时间戳的方式进行对比，谁消耗的时间越少，则性能越高（每次测试 10 轮）。</p>',7),g={href:"https://github.com/xuejmnet/easy-query-benchmark",target:"_blank",rel:"noopener noreferrer"},d=e(`<div class="hint-container tip"><p class="hint-container-title">测试说明</p><blockquote><p>在以下的所有测试中，有可能因为每个人的电脑性能不同，测试的结果会有所不同。</p></blockquote></div><h2 id="测试单条数据查询" tabindex="-1"><a class="header-anchor" href="#测试单条数据查询" aria-hidden="true">#</a> 测试单条数据查询</h2><p>Mybatis-Flex 的代码如下：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token class-name">QueryWrapper</span> queryWrapper <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">QueryWrapper</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
&gt;&gt;&gt;&gt;&gt;&gt;&gt;testEasyUpdate:23
&gt;&gt;&gt;&gt;&gt;&gt;&gt;testPlusUpdate:177
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container tip"><p class="hint-container-title">测试结论</p><blockquote><p>数据更新速度easy-query快于Mybatis-Flex 远快于 Mybatis-Plus，大概是 Mybatis-Plus 的 5~10+ 倍。</p></blockquote></div><h2 id="更多的测试" tabindex="-1"><a class="header-anchor" href="#更多的测试" aria-hidden="true">#</a> 更多的测试</h2>`,54),r={href:"https://github.com/xuejmnet/easy-query-benchmark",target:"_blank",rel:"noopener noreferrer"};function k(v,m){const a=i("ExternalLinkIcon");return c(),l("div",null,[u,s("p",null,[n("测试源码： "),s("a",g,[n("https://github.com/xuejmnet/easy-query-benchmark"),t(a)])]),d,s("p",null,[n("想进一步进行更多测试的同学，可以到 "),s("a",r,[n("https://github.com/xuejmnet/easy-query-benchmark"),t(a)]),n(" 下载源码后，添加其他方面的测试。")])])}const y=p(o,[["render",k],["__file","performance.html.vue"]]);export{y as default};
