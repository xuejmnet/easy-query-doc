import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{o as t,c as i,a,d as n,e}from"./app-c082cc31.js";const l={},r=n("h1",{id:"kotlin配置使用",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#kotlin配置使用","aria-hidden":"true"},"#"),e(" kotlin配置使用")],-1),s=n("p",null,[n("code",null,"eq"),e("不但支持java也支持"),n("code",null,"kotlin"),e("语言的使用,本次我们将使用k2在gradle下进行kotlin的简单的配置和使用")],-1);function c(m,d){return t(),i("div",null,[r,s,a(` ## 创建koltin项目
### 添加依赖
