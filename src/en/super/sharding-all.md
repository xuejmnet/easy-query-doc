...
: <== SHARDING_EXECUTOR_1, name:ds0, Total: 1
```
**New data inserted into corresponding tables in corresponding databases** Seamless support for database and table sharding insertion
...
```
Object update accurately hits the corresponding database and corresponding table
