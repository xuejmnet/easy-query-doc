    ...
    "db_support",
    {
      ...
      children: [
        ...
        },
        {
          text: "查询",
          prefix: "query/",
          children: ["readme.md","basic-type","or-condition","paging","multi-query","group","select","native-sql","dynamic-table","stream-query","to-map","select-column","union","select-sub","sub-query","relation","fill","where","reuse","case-when","dynaimic-where","dynamic-sort"],
        },
        {
          text: "高级",
          prefix: "adv/",
          children: ["readme.md","logic-delete","interceptor","batch","sql-func","column-encryption","column-sql-func-auto","generated-key-sql-column","data-tracking","version","column-func-new","column-func","atomic-update","value-object"],
        },
        {
          text: "超级",
          prefix: "super/",
