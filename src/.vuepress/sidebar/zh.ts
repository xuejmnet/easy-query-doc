...
export const zhSidebar = sidebar({
  "/": [
    ...
    "quick-preview",
    {
      text: "起步",
      prefix: "startup/",
      children: ["readme.md","quick-start","quick-plugin","nodsl","dsl","framework-springboot","multi-module"],
    },
    // "quick-start",
    "question",
    "db_support",
      ...
      children: [
        {
          text: "配置",
          prefix: "config/",
          children: ["readme.md","dependency-injection","config-java","config-kotlin","config-solon","config-spring-boot","config-option","annotation","replace-configure","logging","api-mode","kapt","easy-trans","plugin","plugin-plus-max-ultra"],
        },
        {
          text: "基础操作",
          prefix: "basic/",
        ...
        },
        {
          text: "查询",
          prefix: "query/",
          children: ["readme.md","basic-type","anonymous-type","or-condition","paging","multi-query","group","order","select","native-sql","dynamic-table","stream-query","to-map","select-column","union","select-sub","sub-query","relation","relation-filter","fill","where","reuse","case-when","dynaimic-where","dynamic-sort"],
        },
        {
          text: "高级",
          prefix: "adv/",
