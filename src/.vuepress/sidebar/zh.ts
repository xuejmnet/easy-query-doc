    ...
    "db_support",
    {
      ...
      children: [
        ...
        },
        {
          text: "高级",
          prefix: "adv/",
          children: ["readme.md","logic-delete","auto-key","interceptor","batch","sql-func-v1","sql-func","column-encryption","column-sql-func-auto","data-tracking","version","column-func-new","column-func","value-object","jdbc-listener"],
        },
        {
          text: "超级",
          prefix: "super/",
